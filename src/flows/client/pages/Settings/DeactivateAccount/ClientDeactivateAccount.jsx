...
export default function ClientDeactivateAccount() {
  return (
    <DashboardLayout
      ...
      activeSettingsTab="deactivate-account"
    >
          ...
          >
            <div className="settings-section-header">
              ...
              <p className="settings-section-desc">
                Temporarily suspend your account. You can reactivate at any time.
              </p>
            </div>
            <div className="deactivate-card-row">
              <p className="deactivate-note mb-0">
                Your profile will be hidden from Freelancers/agencies and search results.
              </p>
              <SecondaryButton
